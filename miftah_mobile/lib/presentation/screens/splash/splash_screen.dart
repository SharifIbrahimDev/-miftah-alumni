...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Future<void> _checkAuth() async {
    ...
    final results = await Future.wait([
      ...
      Future.delayed(const Duration(milliseconds: 3000)), // Increased to 3s to let animation finish
    ]);
        ...
        children: [
          ...
          Center(
            child: Column(
              ...
              ].animate(interval: 200.ms).fade(duration: 800.ms).scale(begin: const Offset(0.9, 0.9)),
            ),
          ),
        ],
      ),
